...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				<li class="nav-item" style="padding-top: 18px;"><a
					class="nav-link" href="adminhome">Home <span class="sr-only">(current)</span></a>
				</li>
	...
	<div class="sidenav">
		<a href="addvendors">Add Vendors</a> <a href="addproducts">Add
			Products</a> <a href="vendordetails">Vendor Details</a> <a
			href="userdetails">User Details</a> <a href="productdetails" class="active">Product
			Details</a> 
	</div>
			...
			<c:forEach var="product" items="${list1}">
				<tr>
					...
					<td>
							...
							<%-- <img src="./userDisp?fname=${product.image}" id="example1"  /> --%>
							<img src="./product/image/${product.id}" alt="img" id="example1" />
					
					</td>
					<td>
					<form action="bookeddetails">
